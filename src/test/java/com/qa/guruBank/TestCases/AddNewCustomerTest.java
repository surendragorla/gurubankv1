...
public class AddNewCustomerTest extends TestBase {
	...
	public void AddCustomerTest(String CustomerName, String Dob, String Address, String City, String State,
			String PinCode, String MobileNo, String Email, String Password) throws InterruptedException {
		Thread.sleep(3000);

		newCustomer.verifyNewContactDetails(CustomerName, Dob, Address, City, State, PinCode, MobileNo, Email,
				Password);
